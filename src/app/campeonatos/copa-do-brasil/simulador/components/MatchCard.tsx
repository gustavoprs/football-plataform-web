				...
				<div className="flex gap-1.5 text-lg">
					{match.status === "finished" && (
						<span className="flex items-center gap-1 font-medium">
							{penaltyDispute && <span className="text-sm text-muted-foreground">({match.score.penalty.home})</span>}
					...
					{match.status === "finished" && (
						<span className="flex items-center gap-1 font-medium">
							...
							{penaltyDispute && <span className="text-sm text-muted-foreground">({match.score.penalty.away})</span>}
						</span>
					)}
				</div>
