...
export default function TwoLeggedTieCard({
	...
	return (
		<div className="relative flex flex-col justify-center items-center rounded-md border sm:flex-row md:flex-col lg:flex-row xl:flex-col">
			{index && (
				<span className="absolute z-2 -top-3 rounded-sm border py-0.5 px-1.5 text-xs bg-background">
					{index}
				</span>
			)}
			<MatchDialog match={firstMatch}>
				<div className="flex justify-center items-center size-full cursor-pointer transition-colors hover:bg-accent">
					<div className="relative flex flex-col items-center gap-2 py-4 px-3 h-full">
